...
class MainActivity : AppCompatActivity() {
    ...
    fun paintClicked(view: View){
        if(view != mImageButtonCurrentPaint){
            ...
            mImageButtonCurrentPaint!!.setImageDrawable(
                ContextCompat.getDrawable(this, R.drawable.paller_normal)
            )
        ...
        if(requestCode == STORAGE_PERMISSION_CODE){
            if(grantResults.isNotEmpty() &&
                ...
                Toast.makeText(this, "Permission granted." +
                        " Now you can read the storage files",
                    Toast.LENGTH_LONG).show()
            }
            else{
    ...
    private inner class BitmapAsyncTask(val mBitmap: Bitmap):
            ...
            if(mBitmap != null){
                try{
                    ...
                    mBitmap.compress(Bitmap.CompressFormat.PNG,
                        90, bytes)
                    val f = File(externalCacheDir!!.absoluteFile
                        .toString() + File.separator + "KidDrawingApp" +
            ...
            if(!result!!.isEmpty()){
                ...
                Toast.makeText(this@MainActivity,
                    "Something went wrong" +
                        " while saving the file", Toast.LENGTH_LONG).show()
            }
        ...
        private fun showPreogressDialog(){
