...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setExerciseProgressBar(){
        ...
        exerciseTimer = object: CountDownTimer(exerciseTimerDuration * 1000,
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                tvTimerExercise.text = "${(exerciseTimerDuration-exerciseProgress)}"
            }
    ...
    private fun setupRestView(){
        ...
        // may have issues like typos
//        val soundURI = Uri.parse("android:resource://com.example." +
//                "7minuteworkout/" + R.raw.press_start)
//        player = MediaPlayer.create(applicationContext, soundURI)
        ...
        tvUpcomingExerciseName.text = exerciseList!![currentExercisePosition
                + 1].getName()
        setRestProgressBar()
    ...
    private fun setupExerciseView(){
        ...
        ivImage.setImageResource(exerciseList!![currentExercisePosition].
        getImage())
        tvExerciseName.text = exerciseList!![currentExercisePosition].getName()

    }

//textToSpeech may not be installed so we need to check
    // if we can access texttospeech
