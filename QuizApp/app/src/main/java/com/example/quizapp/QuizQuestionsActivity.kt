...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.tv_option_one -> {
                selectedOptionView(tv_option_one, 1, answered)
            }
            R.id.tv_option_two -> {
                selectedOptionView(tv_option_two, 2, answered)
            }
            R.id.tv_option_three -> {
                selectedOptionView(tv_option_three, 3, answered)
            }
            R.id.tv_option_four -> {
                selectedOptionView(tv_option_four, 4, answered)
            }
            R.id.btn_submit -> {
                if (answered) {
                    mCurrentPosition++
    ...
    private fun selectedOptionView(tv: TextView, selectedOptionNum: Int, answered: Boolean) {
